...
def analyze_csv(input_csv, output_csv):
    ...
    with open(input_csv, 'r', encoding='utf-8') as infile:
        ...
        for row in reader:
            ...
            if any(num in filter_list for num in category_numbers):
             ...
             if "unable to get local issuer certificate" in https_status:
                ssl_data.append(row)
    ...
    grouped_data["Self signed certificate"] = certificate
...
#omly for dns for family dataset  
